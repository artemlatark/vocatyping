...
type CheckTextPick = Pick<CheckText, 'currentWordId' | 'writtenText' | 'wordVariants' | 'currentVariantIndex'>;

const Keyboard: FC<CheckTextPick> = memo(({currentWordId, writtenText, wordVariants, currentVariantIndex}) => {
